...
**v0.0.1 — pre-alpha.** Scaffolding, core router, three reference sinks. Used internally by [Daslab](https://daslab.dev) for routing agent telemetry to multiple backends. API will change. Open issues, send PRs.
